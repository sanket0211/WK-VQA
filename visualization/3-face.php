...
function set_i($val){
	...
	echo "<a href='3-face.php?c=".$sec."'><button>Go to Previous Image</button></a>";
	echo "	</div>";
	echo "  <div class='column' style='background-color:#bbb;'>";
	echo "<a href='3-face.php?c=".$one."'><button>Go to Next Image</button></a>";
	echo "	</div>";
	echo "	</div>";
...
function hello($x){	
	...
	$f = fopen('/home/sanket/kvqa/QAgeneratingFiles/1-face_analysis/3-face.csv', "r");
	while(!feof($f)){
		$line = fgets($f);
