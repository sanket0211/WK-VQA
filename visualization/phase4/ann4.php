...
while (($row = fgetcsv($fileHandle, 0, "\t")) !== FALSE) {
	...
	?>
		...
		<td>
		<?php echo "<u>Order people from Left to right (ONLY if there are FOUR people):</u><br><br>"; ?>
		...
		<input type="radio" name="Q5<?php echo $count; ?>" value="NOT SURE">I am not sure<br><br>
		<input type="radio" name="Q6<?php echo $count; ?>" value="ONE">One face<br><br>
		<input type="radio" name="Q7<?php echo $count; ?>" value="TWO">two faces<br><br>
		<input type="radio" name="Q8<?php echo $count; ?>" value="THREE">Three faces<br><br>
		<input type="radio" name="Q9<?php echo $count; ?>" value="FIVE">five faces<br><br>
		<input type="radio" name="Q10<?php echo $count; ?>" value="MORE">more faces<br><br>
		<input type="radio" name="Q11<?php echo $count; ?>" value="NO">no face<br><br>
