...
$ann_left = fopen("ann5_left/re_annotation.csv", "r");
$left_img_ids = array();
...
while (($row = fgetcsv($fileHandle, 0, "\t")) !== FALSE) 
{
	...
	?>
		...
		<td>
		<?php echo "<u>Order people from Left to right (ONLY if there are FIVE people):</u><br><br>"; ?>
		<input type="text" name="Q1<?php echo $count; ?>" > 1st <br><br>
		<input type="text" name="Q2<?php echo $count; ?>"> 2nd <br><br>
		<input type="text" name="Q3<?php echo $count; ?>"> 3rd <br><br>
		<input type="text" name="Q4<?php echo $count; ?>"> 4th <br><br>
		<input type="text" name="Q5<?php echo $count; ?>"> 5th <br><br>
		<input type="radio" name="Q6<?php echo $count; ?>" value="NOT SURE">I am not sure<br><br>
		<input type="radio" name="Q7<?php echo $count; ?>" value="ONE">one face<br><br>
		<input type="radio" name="Q8<?php echo $count; ?>" value="TWO">two faces<br><br>
		<input type="radio" name="Q9<?php echo $count; ?>" value="THREE">Three faces<br><br>
		<input type="radio" name="Q10<?php echo $count; ?>" value="FOUR">four faces<br><br>
		<input type="radio" name="Q11<?php echo $count; ?>" value="MORE">more faces<br><br>
		<input type="radio" name="Q12<?php echo $count; ?>" value="NO">no face<br><br>
