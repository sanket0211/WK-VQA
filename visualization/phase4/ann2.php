...
$ann_left = fopen("ann2_left/re_annotation.csv", "r");
$left_img_ids = array();
...
<tr>
    ...
    <input type="text" name="Q2<?php echo $count; ?>"> Who is in right?<br><br>
    <input type="radio" name="Q3<?php echo $count; ?>" value="NOT SURE">I am not sure<br><br>
    <input type="radio" name="Q4<?php echo $count; ?>" value="ONE">One face<br><br>
    <input type="radio" name="Q5<?php echo $count; ?>" value="THREE">two face<br><br>
    <input type="radio" name="Q6<?php echo $count; ?>" value="FOUR">four face<br><br>
    <input type="radio" name="Q7<?php echo $count; ?>" value="FIVE">five face<br><br>
    <input type="radio" name="Q8<?php echo $count; ?>" value="MORE">more face<br><br>
    <input type="radio" name="Q9<?php echo $count; ?>" value="NO">no face<br><br>
