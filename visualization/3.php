...
function set_i($val){
	...
	echo "<a href='3.php?c=".$sec."'><button>Go to Previous Image</button></a>";
	echo "	</div>";
	echo "  <div class='column' style='background-color:#bbb;'>";
	echo "<a href='3.php?c=".$one."'><button>Go to Next Image</button></a>";
	echo "	</div>";
	echo "	</div>";
...
function hello($x){	
	...
	$dir    = '/home/sanket/kvqa/QAgeneratingFiles/QA_three';
	$files1 = scandir($dir);
...
#echo 'Image Id: <input type="text" name="name" align="center"><br>';
	...
	fclose($myfile);
	$myfile = fopen('/home/sanket/kvqa/QAgeneratingFiles/QA_three/'.$files1[$x], "r");
	echo '<table border="1">';
	echo '<tr>';
	echo '<td>';
...
#echo "<img src = 'demo.jpeg'></img>";
	...
	fclose($myfile);
	$myfile = fopen('/home/sanket/kvqa/QAgeneratingFiles/QA_three/'.$files1[$x+1], "r");
	echo '<table border="1">';
	echo '<tr>';
	echo '<td>';
	echo "<img src = '".$url."' style = 'max-width:512px; max-height:512px;'></img>";
	...
	/*
	   ...
	   $myfile = fopen('/home/sanket/wikiAttributesExtr/QA_three/'.$files1[$x+1], "r");
