...
csvFile = '../../wikiAttributesExtr/fiveFace.csv'
...
a1=open('5-face_analysis/files_info.csv', 'w')
a2=open('5-face_analysis/questions_count.csv', 'w')
a3=open('5-face_analysis/entities_files_present.csv', 'w')
a4=open('5-face_analysis/entities_files_absent.csv', 'w')
a8=open('5-face_analysis/partially_annotated_file_info.csv', 'w')
a6=open('5-face_analysis/completely_annotated_file_info', 'w')
a7=open('5-face_analysis/complete_analysis.csv', 'w')
a5=open('5-face_analysis/ambiguous_file.csv', 'w')
a9=open('5-face_analysis/ambiguous_our_file.csv', 'w')
a10=open('5-face_analysis/same_name.csv', 'w')
a11=open('5-face_analysis/answers_count.csv', 'w')
qa={}
answers_info={}
file_info={}
question_info={}
...
dup1=open('../datasets/5-face_dup2.csv', 'r')
dups=[]
...
with open(csvFile, 'r') as csvfile:
     ...
     for token in spamreader:
         ...
         if imgId in dups:
             continue
         if(token[6]=="NOT SURE" or token[7] == "ONE" or token[8]=="TWO" or token[9]=="THREE" or token[10]=="FOUR" or token[11]=="MORE" or token[12]=="NO"):
             file_info['Ambiguous']+=1
             img_path=get_image_path(imgId)
             a5.write(str(imgId)+'\t'+img_path+'\t'+token[1]+'\t'+token[2]+'\t'+token[3]+'\t'+token[4]+'\t'+token[5]+'\n')
             continue
         ...
         person5=(token[5].lstrip()).rstrip()
         
         if(person1=="" and person2=="" and person3=="" and person4=="" and person5==""):
         ...
         elif(person1=="" or person2=="" or person3=="" or person4=="" or person5==""):
             file_info['Ambiguous']+=1
             img_path=get_image_path(imgId)
             a8.write(str(imgId)+'\t'+img_path+'\t'+token[1]+'\t'+token[2]+'\t'+token[3]+'\t'+token[4]+'\t'+token[5]+'\n')
         ...
         if person4 in person_not_found:
             ...
             print person4
         if person5 in person_not_found:
             print person5
             actualperson5=final_actual_names[person5]
             person5=final_correct_names[person5]
             print person5
         ...
         f5="../../wikiAttributesExtr/%s.csv" %(person5)
         ...
         if flag5!=1 or person5 in person_data_missing:
             if person5 not in entity_file_absent:
                 entity_file_absent.append(person5)
         ...
         if person4 in person_data_missing:
            flag4=0;
         if person5 in person_data_missing:
            flag5=0;
         ...
         if(flag1*flag2*flag3*flag4*flag5!=1):
             ...
             img_path=get_image_path(imgId)
             a9.write(str(imgId)+'\t'+img_path+'\t'+token[1]+'\t'+token[2]+'\t'+token[3]+'\t'+token[4]+'\t'+token[5]+'\n')
         ...
         if(flag1*flag2*flag3*flag4*flag5==1):
           ...
           if actualperson4!="":
               ...
               person4=person4.replace("_", " ")
           if actualperson5!="":
               person5=actualperson5.replace("_", " ")
           else:
               person5=person5.replace("_", " ")
           ...
           if person5 not in entity_file_present:
               entity_file_present.append(person5)
           ...
           if len(persons)<5:
               ...
               img_path=get_image_path(imgId)
               a10.write(str(imgId)+'\t'+img_path+'\t'+token[1]+'\t'+token[2]+'\t'+token[3]+'\t'+token[4]+'\t'+token[5]+'\n')
               continue
           persons=persons_temp

           file_info['Annotated']+=1
           img_path=get_image_path(imgId)
           a6.write(str(imgId)+'\t'+img_path+'\t'+person1+'\t'+person2+'\t'+person3+'\t'+person4+'\t'+person5+'\n')

           qFileName='QA_temp5/%s-QA.csv' %(imgId)
           ...
           qFile.write("Who is in the center\t")
           qFile.write(person3)
           ...
           y4=getYOB(f4)
           y5=getYOB(f5)
           if(y1!=-1 and y2 != -1 and y3 != -1 and y4 != -1 and y1!='NOT' and y2!='NOT' and y3!='NOT'and y4!='NOT'and y5!='-1'and y5!='NOT' ):
               try:
                   if(y1!=-1 and y2!=-1 and y2!='NO' and y1!='NO'and y3!=-1 and y3!='NO' and y4!=-1 and y4!='NO' and y5!='NOT'and y5!='-1'):
                       ans=0
           ...
           try:
            if(yow4!=-1 and yow4!='NOT'):
               ...
               x=1
           try:
            if(yow5!=-1 and yow5!='NOT'):
                if(yow5!=-1 and yow5!='NOT'):
                    qFile.write("In which year did the person in the right in the image start working?\t")
                    qFile.write(yow5)
                    answers_info[yow5]+=1
                    qFile.write("\n")
                    question_info["In which year did the person [position] in the image start working?"]+=1
           ...
           countryOB.append(getCountyOfBirth(f5)) 
           ...
           continentOB.append(getContinentOfBirth(f5))
           if(countryOB[0] !='NOT-AVAILABLE' and countryOB[1]!= 'NOT-AVAILABLE' and countryOB[2]!='NOT-AVAILABLE' and countryOB[3]!= 'NOT-AVAILABLE' and countryOB[4]!= 'NOT-AVAILABLE'):
              ...
              if(countryOB[0]==countryOB[1] and countryOB[1]==countryOB[2] and countryOB[2]==countryOB[3] and countryOB[3]==countryOB[4]):
                ans="Yes"
              else:
                ans="No"
              qFile.write(ques)
           ...
           if(continentOB[0]!='NOT-AVAILABLE' and continentOB[1] != 'NOT-AVAILABLE' and continentOB[2]!= 'NOT-AVAILABLE' and continentOB[3]!= 'NOT-AVAILABLE' and continentOB[4]!= 'NOT-AVAILABLE'):
              p=random.randint(0,4)
           ...
           place_of_education5=getPlaceOfEducation(f5)
           if place_of_education1[0]!='NOT-AVAILABLE' and place_of_education2[0]!='NOT-AVAILABLE' and place_of_education3[0]!='NOT-AVAILABLE' and place_of_education4[0]!='NOT-AVAILABLE' and place_of_education5[0]!='NOT-AVAILABLE':
             ...
             place_of_education5[0]=eval(place_of_education5[0])
             ...
             for places in place_of_education4[0]:
              total_list_edu_places.append(places)
             for places in place_of_education5[0]:
             	total_list_edu_places.append(places)
             ...
             edu_place = total_list_edu_places[random.randint(0, total_no_of_edu_places-1)]
           	 #print edu_place
             ans = ""
             if edu_place in place_of_education1[0] and edu_place not in place_of_education2[0] and edu_place not in place_of_education3[0] and edu_place not in place_of_education4[0] and edu_place not in place_of_education5[0]:
              ques = 'Who among the people in the image studied at '+edu_place+'?'
              ans = 'Person in the left'
             elif edu_place in place_of_education2[0] and edu_place not in place_of_education1[0] and edu_place not in place_of_education3[0] and edu_place not in place_of_education4[0] and edu_place not in place_of_education5[0]:
              ques = 'Who among the people in the image studied at '+edu_place+'?'
              ans = 'Person second from left'
             elif edu_place in place_of_education3[0] and edu_place not in place_of_education1[0] and edu_place not in place_of_education2[0] and edu_place not in place_of_education4[0]and edu_place not in place_of_education5[0]:
              ques = 'Who among the people in the image studied at '+edu_place+'?'
              ans = 'Person in the center'
             elif edu_place in place_of_education4[0] and edu_place not in place_of_education1[0] and edu_place not in place_of_education2[0] and edu_place not in place_of_education3[0] and edu_place not in place_of_education5[0]:
              ques = 'Who among the people in the image studied at '+edu_place+'?'
              ans = 'Person second from right'
             elif edu_place in place_of_education5[0] and edu_place not in place_of_education1[0] and edu_place not in place_of_education2[0] and edu_place not in place_of_education3[0] and edu_place not in place_of_education4[0]:
              ques = 'Who among the people in the image studied at '+edu_place+'?'
             ...
             for edu_place in place_of_education1[0]:
              if edu_place in place_of_education2[0] and edu_place in place_of_education3[0] and edu_place in place_of_education4[0] and edu_place in place_of_education5[0]:
                ans = "Yes\n"
                break
              else:
                ans = "No\n"
           ...
           language5=getLanguage(f5)
           if language1[0]!='NOT-AVAILABLE' and language2[0]!='NOT-AVAILABLE' and language3[0]!='NOT-AVAILABLE' and language4[0]!='NOT-AVAILABLE' and language5[0]!='NOT-AVAILABLE':
           	 ...
           	 if language4[0]!='NOT-AVAILABLE':
           	 	...
           	 	for l in language4[0]:
           	 		total_list_of_languages.append(l)
           	 if language5[0]!='NOT-AVAILABLE':
           	 	language5[0]=eval(language5[0])
           	 	for l in language5[0]:
           	 		total_list_of_languages.append(l)
           	 if language1[0]=='NOT-AVAILABLE':
           	 	language1[0]=[]
           	 if language2[0]=='NOT-AVAILABLE':
           	 ...
           	 if language in language4[0]:
           	 	ans = ans + 1
           	 if language in language5[0]:
           	 	ans = ans + 1
           	 qFile.write(ques+'\t')
                 question_info["How many people in the image speak [Language]?"]+=1
           	 qFile.write(str(ans)+'\n')
           	 if language1[0]!=[] and language2[0]!=[] and language3[0]!=[] and language4[0]!=[] and language5[0]!=[]:
           	 	ques='Do people in the image have speak at least one common  language?'
	           	 #print language1[0]
	           	 #print language2[0]
	           	for l in language1[0]:
	           	 	if l in language2[0] and l in language3[0] and l in language4[0] and l in language5[0]:
	           	 		ans = "Yes\n"
	           	 		break
	           	 	else:
	           	 		ans = "No\n"
	           	qFile.write(ques+'\t')
	           	qFile.write(ans)
                        question_info["Do people in the image have speak at least one common  language?"]+=1
           '''
           ...
           spouse5=getSpouse(f5)
           if spouse1[0]!='NOT-AVAILABLE' or spouse2[0]!='NOT-AVAILABLE' or spouse3[0]!='NOT-AVAILABLE' or spouse4[0]!='NOT-AVAILABLE' or spouse5[0]!='NOT-AVAILABLE':
           	 ...
           	 if spouse4[0]!='NOT-AVAILABLE':
           	 	...
           	 	for l in spouse4[0]:
           	 		total_list_of_spouses.append(l)
           	 if spouse5[0]!='NOT-AVAILABLE':
           	 	spouse5[0]=eval(spouse5[0])
           	 	for l in spouse5[0]:
           	 		total_list_of_spouses.append(l)
           	 if spouse1[0]=='NOT-AVAILABLE':
           	 	spouse1[0]=[]
           ...
           nick5=getNickName(f5)
           if nick1[0]!='NOT-AVAILABLE' or nick2[0]!='NOT-AVAILABLE' or nick3[0]!='NOT-AVAILABLE' or nick4[0]!='NOT-AVAILABLE' or nick5[0]!='NOT-AVAILABLE':
           	 print imgId
           	 ...
           	 #print edu_place
           	 ques = 'Who among the people in the image is called by the nick-name '+nick+'?'
           	 if nick in nick1:
           	 	ans = 'Person in the left'
           	 elif nick in nick2:
           	 	ans = 'Person second from left'
           ...
           political_party5=getPoliticalParty(f5)
           ...
           political_party_founder5 = getPoliticalPartyFounder(f5)
           if political_party1[0]!='NOT-AVAILABLE' and political_party2[0]!='NOT-AVAILABLE' and political_party3[0]!='NOT-AVAILABLE' and political_party3[0]!='NOT-AVAILABLE' and political_party4[0]!='NOT-AVAILABLE':
           	 #print imgId
           	 ...
           	 if political_party in political_party4:
           	 	ans = ans + 1
           	 if political_party in political_party5:
           	 	ans = ans + 1
           	 qFile.write(ques+'\t')
           	 ...
           	 qFile.write(str(ans)+'\n')
                 ...
                 a=str(ans)
                 qa_gen(q,a)
           	 if political_party1!=[] and political_party2!=[] and political_party3!=[] and political_party4!=[] and political_party5!=[]:
	           	 ...
	           	 for l in political_party1:
	           	 	...
	           	 	if l in political_party2 and l in political_party3 and l in political_party4 and l in political_party5:
	           	 		ans = "Yes"
	           	 		break
	           	 	else:
	           	 		ans = "No"
       	   ...
       	   if political_party_founder1!='NOT-AVAILABLE':
       	   	 #print imgId
       	   	 ques = 'Who is the founder of the Political Party person on the left belongs to?\t'
           ...
           occupation5=getoccupation(f5)
           if occupation1[0]!='NOT-AVAILABLE' and occupation2[0]!='NOT-AVAILABLE' and occupation3[0]!='NOT-AVAILABLE' and occupation5[0]!='NOT-AVAILABLE':
           	 #print imgId
           	 ...
           	 if occupation4[0]!='NOT-AVAILABLE':
           	 	...
           	 	for l in occupation4[0]:
           	 		total_list_of_occupations.append(l)
           	 if occupation5[0]!='NOT-AVAILABLE':
           	 	occupation5[0]=eval(occupation5[0])
           	 	for l in occupation5[0]:
           	 		total_list_of_occupations.append(l)
           	 if occupation1[0]=='NOT-AVAILABLE':
           	 	occupation1[0]=[]
           	 if occupation2[0]=='NOT-AVAILABLE':
           	 ...
           	 if occupation in occupation4[0]:
           	 	ans = ans + 1
           	 if occupation in occupation5[0]:
           	 	ans = ans + 1
           	 qFile.write(ques+'\t')
           	 ...
           	 qFile.write(str(ans)+'\n')
                 ...
                 a=str(ans)
                 qa_gen(q,a)
           	 if occupation1[0]!=[] and occupation2[0]!=[] and occupation3[0]!=[] and occupation4[0]!=[] and occupation5[0]!=[]:
	           	 ...
	           	 for l in occupation1[0]:
	           	 	...
	           	 	if l in occupation2[0] and l in occupation3[0] and l in occupation4[0] and l in occupation5[0]:
	           	 		ans = "Yes"
	           	 		break
	           	 	else:
	           	 		ans = "No"
...
import json
print qa
with open('5-face_analysis/qa.json','w') as fp:
    json.dump(qa,fp)
#print(temp_dict)
#normalizeplot()
#plotdetails()
...
#plt.show()
#plt.savefig('5-face_plots/1.png', bbox_inches='tight')
